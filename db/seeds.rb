...
if UserType.count == 0
  UserType.create!([
    {name: "Administrador"},
    {name: "Consultas SESAI Central"},
    {name: "Operador SESAI Central"},
    {name: "Consultas DSEI"},
    {name: "Operador DSEI"},
  ])
end
...
if Cost.count == 0
  Cost.create!([
    ...
    { name: 'ALIMENTAÇÃO', ask_distribution: true, data_type: 'money', parent_id: 10 },
    { name: '3.3.90.30.07 - Gêneros de Alimentação', ask_distribution: true, data_type: 'money', parent_id: 11 },
    { name: '3.3.90.36.23 - Fornecimento de Alimentação (Outros Serviços de Terceiros - Pessoa Física)', ask_distribution: true, data_type: 'money', parent_id: 11 },
    { name: '3.3.90.39.41 - Fornecimento de Alimentação (Outros Serviço de Terceiros - Pessoa Jurídica)', ask_distribution: true, data_type: 'money', parent_id: 11 },

    { name: 'HORAS VÔO', ask_distribution: false, data_type: 'money', parent_id: 10 },
    { name: '3.3.90.33.03 - Horas Vôo', ask_distribution: true, data_type: 'money', parent_id: 15 },

    { name: 'LOCAÇÃO DE VEÍCULOS', ask_distribution: true, data_type: 'money', parent_id: 10 },
    { name: '3.3.90.33.03 - Locação de Veículos', ask_distribution: true, data_type: 'money', parent_id: 17 },
    { name: '3.3.90.33.05 - Locomoção Urbana', ask_distribution: true, data_type: 'money', parent_id: 17 },
    { name: '3.3.90.33.09 - Transporte de Servidores', ask_distribution: true, data_type: 'money', parent_id: 17 },

    { name: 'LOCAÇÃO DE MÃO DE OBRA', ask_distribution: true, data_type: 'money', parent_id: 10 },
    { name: '3.3.90.37.01 - Secretária e Recepcionista', ask_distribution: true, data_type: 'money', parent_id: 21 },
    { name: '3.3.90.37.01 - Motorista', ask_distribution: true, data_type: 'money', parent_id: 21 },
    { name: '3.3.90.37.01 - Barqueiro', ask_distribution: true, data_type: 'money', parent_id: 21 },
    { name: '3.3.90.37.01 - Artíficie', ask_distribution: true, data_type: 'money', parent_id: 21 },
    { name: '3.3.90.37.02 - Limpeza e Conservação', ask_distribution: true, data_type: 'money', parent_id: 21 },
    { name: '3.3.90.37.03 - Vigilância Ostensiva', ask_distribution: true, data_type: 'money', parent_id: 21 },
    { name: '3.3.90.37.05 - Serviço de Copa e Cozinha ', ask_distribution: true, data_type: 'money', parent_id: 21 },
    { name: '3.3.90.37.06 - Manutenção e Conservação de Bens Movéis', ask_distribution: true, data_type: 'money', parent_id: 21 },

    { name: 'OUTROS CONTRATOS', ask_distribution: false, data_type: 'money', parent_id: 10 },
    { name: '3.3.90.30.03 - Combustíveis e Outros Materiais Lubrificantes', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.04 - Gás e Outros Materiais Engarrafados', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.14 - Material Educativo e Esportivo', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.16 - Material de Expediente', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.17 - Material de Processamento de Dados', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.19 - Material de Acondicionamento e Embalagem', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.20 - Material de Cama, Mesa e Banho', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.21 - Material de Copa e Cozinha', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.22 - Material de Limpeza e Prod. de Higienização', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.23 - Uniformes, Tercidos e Aviamentos', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.25 - Material p/Manutenção de Bens Móveis', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.26 - Material Elétrico e Eletrônico', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.28 - Material de Proteção e Segurança', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.34 - Sobressal. Máq. e Motores, Navios e Embarcações', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.39 - Material p/ Manutenção de Veículos', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.42 - Ferramentas', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.30.44 - Material de Sinalização Visual e Outros', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.33.03 - Embarcação Fluvial', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.33.08 - Pedágios', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.36.06 - Serviços Técnicos Profissionais', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.36.15 - Locação de Imóveis', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.36.16 - Locação de Bens Móveis e Intangíveis', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.36.17 - Tributos a Conta do Locatário ou Cessionário ', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.36.35 - Serviço de Apoio Administrativo, Técnico e Operacional', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.36.46 - Diárias a Conselheiros', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.36.80 - Hospedagens', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.01 - Assinatura de Periódicos e Anuidade', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.05 - Serviços Técnicos Profissionais', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.08 - Manutenção de Software', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.09 - Armazenagem', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.10 - Locação de Imóveis', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.11 - Locação de Software', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.70 - Confecções de Uniformes, Bandeiras e Flâmulas', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.74 - Fretes e Transp. de Encomendas  ', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.75 - Serviço de Incineração, Destruição e Demolição', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.78 - Limpeza e Conservação', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.80 - Hospedagens', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.83 - Serviços de Cópias e Reprodução de Documentos', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.95 - Manutenção e Conserv. Equip. de Processamento de dados', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.90.39.97 - Comunicação de Dados', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.91.39.01 - Assinaturas e Periódicos e Anuidades', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.91.39.47 - Serviços de Comunicação em Geral ', ask_distribution: true, data_type: 'money', parent_id: 30 },
    { name: '3.3.91.39.90 - Serviços de Publicidade Legal', ask_distribution: true, data_type: 'money', parent_id: 30 }
  ])
end
