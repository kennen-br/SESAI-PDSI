...
if Result.count == 0
  Result.create!([
    ...
    { result_strategy_id: 3 , result_level_id:  1 , is_boolean: false , is_specific:  false , is_percentage:  false , name: 'Reformar/ampliar 26 Casas de Saúde Indígena (CASAI).  ', value_2016:  3 , value_2017: 10  , value_2018: 10  , value_2019: 3 , result_text: '  [VALUE] CASAIS construídas ou reformadas  ', orientacoes_dsei: '    ', orientacoes_sistema: ' DSEI poderá colocar qualquer número inteiro ', value_global: 0},
    { result_strategy_id: 3 , result_level_id:  1 , is_boolean: false , is_specific:  false , is_percentage:  false , name: '34 DSEIs contam com Rede de lógica e internet funcionando adequadamente.  ', value_2016:  4 , value_2017: 10  , value_2018: 10  , value_2019: 10  , result_text: '  [VALUE] DSEIs contam com Rede de lógica e internet funcionando adequadamente. ', orientacoes_dsei: '    ', orientacoes_sistema: ' DSEI tem liberdade para propor produtos ', value_global: 0},
    ...
    { result_strategy_id: 5 , result_level_id:  1 , is_boolean: false , is_specific:  false , is_percentage:  true  , name: '[VALUE]% do GEOSI desenvolvido com painel de controle funcionando.   ', value_2016:  0 , value_2017: 0 , value_2018: 0 , value_2019: 0 , result_text: '  33% do GEOSI desenvolvido com painel de controle funcionando.   ', orientacoes_dsei: '    ', orientacoes_sistema: ' NÃO ENTRA NO PDSI ', value_global: 33},
